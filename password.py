...
class Window():
    ...
    def initUI(self):
        ...
        self.label_chars = tkinter.Label(self.master, 
                text="CHOOSE THE PASSWORD STYLE: ",font=("arial",10,'bold'),bd=10,fg="yellow",bg="black")
        ...
        self.label_num_chars = tkinter.Label(self.master, text="Password Length:",font=("arial",10,'bold'),bd=10,fg="yellow",bg="black")
        ...
        self.button_generate = tkinter.Button(self.frame_buttons, text="Generate", width=8,font=("Algerian",10,'bold'),bd=10,fg="RED",bg="BLACK", command=lambda: self.set_password())
        self.button_close = tkinter.Button(self.frame_buttons, text="Close", command=self.master.quit, width=8,font=("Algerian",10,'bold'),bd=10,fg="RED",bg="BLACK")
